...
public class ANLF extends CommonRec {
    ...
    public static void main(String[] args) throws IOException {
        ...
        CommonRec.dataSetName = "Jester_200";
        String filePath = "E:\\workspace-jasonchung\\Selected_DS\\7-1-2\\";
        CommonRec.dataLoad(filePath + CommonRec.dataSetName + "_train.txt", filePath + CommonRec.dataSetName+ "_test.txt","::");
    ...
    public static void experimenter(int metrics) throws IOException {
        ...
        for (double tempLam = Math.pow(2,0); tempLam <= Math.pow(2,0); tempLam *= 2) {
            ...
            // 按学习率eta取值的不同进行测试
            for(double tempEta = Math.pow(2,0); tempEta <= Math.pow(2,1); tempEta += 0.2){
